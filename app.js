...
const createNewTaskElement = function (taskString) {
  ...
  checkBox.classList.add('input', 'list__input', 'input__checkbox');
  //label
  const label = document.createElement("label");//label
  label.classList.add('list__task-text', 'task__todo');
  //input (text)
  const editInput = document.createElement("input");//text
  editInput.classList.add('input', 'list__input', 'input__text');
  //button.edit
  const editButton = document.createElement("button");//edit button
  editButton.classList.add('button', 'list__button', 'button__edit');

  //button.delete
  const deleteButton = document.createElement("button");//delete button
  deleteButton.classList.add('button', 'list__button', 'button__delete');
